...
class Arguments:
    ...
    def __init__(self, logger):
        ...
        if self.dataset == "cifar_10":
            ...
            self.ba_data_loader_pickle_path = "data_loaders/fashion-mnist/ba_data_loader.pickle"
            self.dba_data_loader_pickle_path = "data_loaders/fashion-mnist/dba_data_loader.pickle"
            self.backdoor_test_data_loader_pickle_path = "data_loaders/fashion-mnist/backdoor_test_data_loader.pickle"
    ...
    def get_ba_data_loader_pickle_path(self):
        return self.ba_data_loader_pickle_path

    def get_dba_data_loader_pickle_path(self):
        return self.dba_data_loader_pickle_path
    ...
    def get_result_name(self):
        name = ""
        for item in self.result_name_function_list:
            name += str(item) + "_"
        return name
