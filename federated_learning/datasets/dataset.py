...
class Dataset:
	...
	def get_ba_dataset(self):
		"""
		Returns the test dataset.

		:return: tuple
		"""
		return self.ba_dataset

	def get_dba_dataset(self):
		"""
		Returns the test dataset.

		:return: tuple
		"""
		return self.dba_dataset

	def get_backdoor_test_dataset(self):
		"""
		Returns the test dataset.

		:return: tuple
		"""
		return self.backdoor_test_dataset
	#
	...
	def load_ba_dataset(self):
		"""
		Loads & returns the ba dataset.

		:return: tuple
		"""
		raise NotImplementedError("load_ba_dataset() isn't implemented")

	@abstractmethod
	def load_dba_dataset(self):
		"""
		Loads & returns the dba dataset.
