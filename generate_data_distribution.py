...
if __name__ == '__main__':
    ...
    BA_DATA_LOADER_FILE_PATH = "data_loaders/fashion-mnist/ba_data_loader.pickle"
    DBA_DATA_LOADER_FILE_PATH = "data_loaders/fashion-mnist/dba_data_loader.pickle"
    BACKDOOR_TEST_DATA_LOADER_FILE_PATH = "data_loaders/fashion-mnist/backdoor_test_data_loader.pickle"
    ...
    train_data_loader = generate_train_loader(args, dataset)
    test_data_loader = generate_test_loader(args, dataset)
    ba_data_loader = generate_ba_loader(args, dataset)
    dba_data_loader = generate_dba_loader(args, dataset)
    backdoor_test_data_loader = generate_backdoor_test_loader(args, dataset)
    ...
    with open(BA_DATA_LOADER_FILE_PATH, "wb") as f:
        save_data_loader_to_file(ba_data_loader, f)
