...
from federated_learning.datasets.data_distribution import distribute_batches_equally,distribute_batches_bias, distribute_batches_1_class, distribute_batches_2_class, distribute_batches_dirichlet, distribute_batches_iid_ba, distribute_batches_iid_dba
...
def train_subset_of_clients(epoch, args, clients, poisoned_workers):
    ...
    elif args.get_aggregation_method() == "multi":
